...
const
    ...
    SENDGRID_API_KEY = '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',
...
function send(user, admin) {
    ...
    from_email = new helper.Email('contato@getokr.com', 'OKR Software')
                                                ...
                                                <td>
                                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td style="font-family: 'Open Sans', Helvetica, arial, sans-serif; font-size: 14px; color: #666666; text-align:center; line-height: 30px; " st-content="fulltext-content">
                                                                    <p style="margin-top: 0!important; font-family: Open Sans, Helvetica, arial, sans-serif; font-size: 16px; font-weight:400; color: #666; text-align:center; line-height: 28px;">Se você tiver quaisquer perguntas ou comentários, envie e-mail para michael.martins@fcamara.com.br</p>
                                                                </td>
                                                            </tr>
                                                            <!-- End of content -->
                                                        </tbody>
